...
const Editreportfour = () => {
  ...
  const getquartercharges = () => {
    axios
      .get(`http://localhost:3001/quarterchargesfour/${location.state.project_id}`, {})
      .then((res) => {
  ...
  const getindic = () => {
    axios
      .get(`http://localhost:3001/indicreportfour/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setIndic(res.data)
      }).catch((error) => {
  ...
  const getdetail = () => {
    axios
      .get(`http://localhost:3001/detailreportfour/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setDetail(res.data)
      }).catch((error) => {
  ...
  const getproblem = () => {
    axios
      .get(`http://localhost:3001/problemreportfour/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setProblem(res.data)
      }).catch((error) => {
