...
const Editreportthree = () => {
  ...
  const getquartercharges = () => {
    axios
      .get(`http://localhost:3001/quarterchargesthree/${location.state.project_id}`, {})
      .then((res) => {
  ...
  const getindic = () => {
    axios
      .get(`http://localhost:3001/indicreportthree/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setIndic(res.data)
      }).catch((error) => {
  ...
  const getdetail = () => {
    axios
      .get(`http://localhost:3001/detailreportthree/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setDetail(res.data)
      }).catch((error) => {
  ...
  const getproblem = () => {
    axios
      .get(`http://localhost:3001/problemreportthree/${location.state.project_id}`, {})
      .then((res) => {
        console.log(res.data)
        setProblem(res.data)
      }).catch((error) => {
